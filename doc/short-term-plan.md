...
- [ ] `index.html` 行数 < 200 行（仅 HTML 结构）
- [ ] `admin.html` 行数 < 400 行（仅 HTML 结构）
- [ ] 公共函数无重复代码
- [ ] 所有功能正常（登录、录入、查询、导入导出、备份）
- [ ] 浏览器控制台无报错
...
- [ ] 页面加载自动填充今天的日期和当前 UTC 时间
- [ ] 「今天」和「现在 UTC」按钮功能正常
- [ ] EYEBALL 类型自动填充日期、清空时间
- [ ] 手动修改后不自动覆盖
